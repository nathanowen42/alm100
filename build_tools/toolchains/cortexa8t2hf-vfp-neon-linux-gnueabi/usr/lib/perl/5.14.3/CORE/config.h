 ...
 */
#define CPPSTDIN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8  -E"
#define CPPMINUS "-"
#define CPPRUN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8  -E"
#define CPPLAST "-"

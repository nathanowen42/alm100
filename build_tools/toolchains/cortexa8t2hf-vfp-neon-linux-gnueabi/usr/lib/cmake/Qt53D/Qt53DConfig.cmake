...
get_filename_component(_realOrig "/usr/lib/cmake/Qt53D" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt53D_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt53D_VERSION_STRING 5.3.0)
...
macro(_populate_3D_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3D PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt53D_LIB_DEPENDENCIES}"
...
if (NOT TARGET Qt5::3D)
    ...
    set(_Qt53D_OWN_INCLUDE_DIRS "${_qt53D_install_prefix}/include/qt5/" "${_qt53D_install_prefix}/include/qt5/Qt3D")
    set(Qt53D_PRIVATE_INCLUDE_DIRS
        "${_qt53D_install_prefix}/include/qt5/Qt3D/5.3.0"
        "${_qt53D_install_prefix}/include/qt5/Qt3D/5.3.0/Qt3D"
    )
    ...
    # specified.
    list(FIND Qt53D_FIND_COMPONENTS Private _check_private)
    if (NOT _check_private STREQUAL -1)
        foreach(_dir ${Qt53D_PRIVATE_INCLUDE_DIRS})
            _qt5_3D_check_file_exists(${_dir})
        endforeach()
    endif()
    ...
    set(Qt53D_EXECUTABLE_COMPILE_FLAGS "")

    foreach(_module_dep ${_Qt53D_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.0 ${_Qt53D_FIND_VERSION_EXACT}
    ...
    _populate_3D_target_properties(RELEASE "libQt53D.so.5.3.0" "" )




    file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt53D_*Plugin.cmake")

    macro(_populate_3D_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        set_property(TARGET Qt5::${Plugin} APPEND PROPERTY IMPORTED_CONFIGURATIONS ${Configuration})

        set(imported_location "${_qt53D_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3D_check_file_exists(${imported_location})

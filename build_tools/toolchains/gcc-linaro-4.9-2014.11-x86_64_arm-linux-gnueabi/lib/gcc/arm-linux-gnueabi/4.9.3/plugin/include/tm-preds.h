/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildslave/workspace/BinaryRelease/label/x86_64/target/arm-linux-gnueabi/snapshots/gcc-linaro-4.9-2014.11/gcc/config/arm/arm.md'.  */
